 ...
 */
    ...
    L.Draw.Polyline = L.Draw.Feature.extend({
        ...
        removeHooks: function () {
            ...
            this._map
                ...
                .off('dblclick', this._onDblclickHndler, this);
        },
        //wanghao add
        _onDblclickHndler: function (e) {
        ...
        _onMouseMove: function (e) {
            ...
            //wanghao add            this._map.fire("draw:drawing", { layer: this._poly, latlng: latlng });
        },
    ...
    L.Edit.PolyVerticesEdit = L.Handler.extend({
        ...
        addHooks: function () {
            ...
            if (poly.options.editing == null && poly.editing)
                poly.options.editing = poly.editing;
        ...
        removeHooks: function () {
            ...
            if (path) {
                if (poly.editing.className) {
                    poly.editing.className.split(' ').forEach(function (className) {
                        L.DomUtil.removeClass(path, className);
                    });
                    if (poly.options.original.className) {
                        poly.options.original.className.split(' ').forEach(function (className) {
